...
const Page2 = () => {
  ...
  return (
    <div id='section2' className=' bg-white text-center  text-black'>
        <h3 className=' text-[1.5vw] font-[anzo] text-gray-500 mt-3'>©  anzo.studio 2024 | designed and developed</h3>
        <div className='rotateText mt-32'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>IMPACTFUL</h1>
        </div>
        <div className=' rotateText'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>DESIGN</h1>
        </div>
        <div className=' rotateText'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>IS THE</h1>
        </div>
        <div className=' rotateText'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>DESIGN</h1>
        </div>
        <div className=' rotateText'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>THAT</h1>
        </div>
        <div className=' rotateText'>
            <h1 className=' text-[42vw] font-[anzo1] text-black uppercase leading-[33vw]'>WORKS!</h1>
        </div>
    ...
    <g>
        ...
        <div className=' bg-black h-1 w-96 left-1/2 -translate-x-1/2 absolute mt-10'></div>
    </div>
  )
}
